...
map.getView().fit([8526091.384598, 1073374.287071, 8590455.419500, 1110726.047191], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RESOURCE MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (37 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS MAP IS CREATED FOR GIS PRACTICAL';
            }
